...
| M0-005 | Create `TimeTrackerMcp.csproj` targeting .NET 10 | S | P0 | M0-004 | [ ] |
| M0-006 | Add `ModelContextProtocol.Server` NuGet package | XS | P0 | M0-005 | [ ] |
| M0-007 | Create `tests/TimeTrackerMcp.Tests/` project folder | XS | P0 | M0-003 | [ ] |
| M0-008 | Create `TimeTrackerMcp.Tests.csproj` with xUnit references | S | P0 | M0-007 | [ ] |
